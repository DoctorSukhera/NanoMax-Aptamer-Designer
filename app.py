...
LOGO_PATH = ASSET_DIR / "hitsz-logo.jpg"
ASYMMETRY_FIG = ASSET_DIR / "nanomax_asymmetry_index.png"
WORKFLOW_FIG = ASSET_DIR / "nanomax_workflow.png"
NANO_3D_FIG = ASSET_DIR / "nanoparticle_3d_asymmetry.png"
...
st.markdown(
    ...
    <div class="hero-shell">
      ...
      <h1 class="hero-title">NanoMax Aptamer<br>Inverse Folding Model</h1>
      <p class="hero-sub">
...
with project_tab:
    ...
    if WORKFLOW_FIG.exists():
        ...
        st.caption("Project workflow illustrating target-feature definition, inverse sequence generation, structural analysis and downstream nanomaterial design concept.")

    st.markdown("### Secondary-structure asymmetry index")
...
with science_tab:
    ...
    if NANO_3D_FIG.exists():
        ...
        st.caption("Conceptual three-dimensional asymmetry quantification workflow for a gold nanoparticle morphology.")
